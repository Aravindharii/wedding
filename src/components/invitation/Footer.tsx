...
export default function Footer() {
  return (
    <footer className="relative bg-surface text-ink/50 text-center text-sm overflow-hidden py-24 group">
      ...
      {/* Subtle glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-teal-400/10 blur-[100px] rounded-full pointer-events-none" />
      ...
      >
        <div className="font-serif text-4xl md:text-5xl text-ink mb-8 tracking-wide drop-shadow-sm group-hover:scale-105 transition-transform duration-700">
          <span className="text-gradient font-semibold">Shahabas</span> <span className="text-gold italic mx-2 drop-shadow-md group-hover:rotate-12 inline-block transition-transform duration-500">&amp;</span> <span className="text-gradient font-semibold">Zaira</span>
        </div>
